...
?>
    <li id="ffwp-ll-menu-item" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children ffwp-ll-menu-item" aria-haspopup="true">
        <a href="/account/" class="menu-link">
            <?php
            $fill_top    = is_user_logged_in() ? '#fff' : 'none';
        ...
        <ul class="sub-menu">
            ...
            <?php if (is_user_logged_in()) : ?>
                ...
                <li id="menu-item-license-keys" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-license-keys">
                    <a href="/account/license-keys/" class="menu-link"><?= __('Your License Keys', 'ffwp-ll'); ?></a>
                </li>
                <li id="menu-item-subscriptions" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-subscriptions">
                    <a href="/account/subscriptions/" class="menu-link"><?= __('Your Subscriptions', 'ffwp-ll'); ?></a>
                </li>
